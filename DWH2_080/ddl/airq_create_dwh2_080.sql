...
-- -------------------------------
DROP TABLE IF EXISTS dwh2_080.ft_param_city_month CASCADE;
DROP TABLE IF EXISTS dwh2_080.dim_alertpeak CASCADE;
DROP TABLE IF EXISTS dwh2_080.dim_param CASCADE;
DROP TABLE IF EXISTS dwh2_080.dim_city CASCADE;
DROP TABLE IF EXISTS dwh2_080.dim_timemonth CASCADE;
